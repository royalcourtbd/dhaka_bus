...
class GetBusesByServiceTypeUseCase extends BaseUseCase<List<BusEntity>> {
  final BusRepository _busRepository;

  GetBusesByServiceTypeUseCase(
    this._busRepository,
    ErrorMessageHandler errorMessageHandler,
  ) : super(errorMessageHandler);

  Future<Either<String, List<BusEntity>>> execute(String serviceType) async {
    return await _busRepository.getBusesByServiceType(serviceType);
  }
}
